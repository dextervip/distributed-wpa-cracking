...
\chapter{Projeto}
	\section{Protocolo}
		...
		{Solicita a inicialização do processo em um cliente, onde \emph{charset} é o conjunto de caracteres utilizados para geração do dicionario, \emph{min} é o tamanho mínimo e \emph{max} tamanho máximo para geração das palavras no dicionário, \emph{part} e \emph{totalClients} dizem a parte que cliente necessita gerar e o número total de clientes}
		{
